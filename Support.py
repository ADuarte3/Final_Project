...
def plot_survival_curves_and_histograms(sim_outcomes_scopy, sim_outcomes_graphy):

    # get survival curves of both treatments
    survival_curves = [
        sim_outcomes_scopy.nLivingPatients,
        sim_outcomes_graphy.nLivingPatients
    ]
    ...
    Path.plot_sample_paths(
        ...
        legends=['Colonoscopy', 'CT Colonography'],
        color_codes=['green', 'blue']
    )

    # histograms of survival times
    set_of_survival_times = [
        sim_outcomes_scopy.survivalTimes,
        sim_outcomes_graphy.survivalTimes
    ]
...
def print_comparative_outcomes(sim_outcomes_scopy, sim_outcomes_graphy):

    # increase in mean survival time under combination therapy with respect to colonoscopy
    increase_survival_time = Stat.DifferenceStatIndp(
        name='Increase in mean survival time',
        x=sim_outcomes_graphy.survivalTimes,
        y_ref=sim_outcomes_scopy.survivalTimes)
    ...
    # increase in mean discounted cost under colonography with respect to colonoscopy
    increase_discounted_cost = Stat.DifferenceStatIndp(
        name='Increase in mean discounted cost',
        x=sim_outcomes_graphy.costs,
        y_ref=sim_outcomes_scopy.costs)
    ...
    # increase in mean discounted utility under colonography with respect to colonoscopy
    increase_discounted_utility = Stat.DifferenceStatIndp(
        name='Increase in mean discounted utility',
        x=sim_outcomes_graphy.utilities,
        y_ref=sim_outcomes_scopy.utilities)
...
def report_CEA_CBA(sim_outcomes_scopy, sim_outcomes_graphy):

    # define two strategies
    scopy_therapy_strategy = Econ.Strategy(
        name='Colonoscopy',
        cost_obs=sim_outcomes_scopy.costs,
        effect_obs=sim_outcomes_scopy.utilities,
        color='green'
    )
    graphy_therapy_strategy = Econ.Strategy(
        name='Colonography',
        cost_obs=sim_outcomes_graphy.costs,
        effect_obs=sim_outcomes_graphy.utilities,
        color='blue'
    )
    ...
    CEA = Econ.CEA(
        strategies=[scopy_therapy_strategy, graphy_therapy_strategy],
        if_paired=False
    )
